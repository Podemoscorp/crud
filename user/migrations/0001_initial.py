# Generated by Django 3.1.6 on 2021-02-15 20:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateTimeField(blank=True, default=django.utils.timezone.now, verbose_name='data de registro')),
                ('soft_delet', models.DateTimeField(blank=True, null=True, verbose_name='Deleted ?')),
                ('is_trusty', models.DateTimeField(blank=True, null=True, verbose_name='is trusty')),
                ('cpf', models.CharField(blank=True, max_length=15, unique=True, verbose_name='CPF')),
                ('endereco', models.CharField(blank=True, max_length=100, verbose_name='Address')),
